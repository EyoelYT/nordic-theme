...
(let ((class '((class color) (min-colors 89)))
      ...
      (nordic-night-bluegreen7 (if (nordic-night-display-truecolor-or-graphic-p) "#8FBCBB" "cyan"))
      (nordic-night-brightblue8 (if (nordic-night-display-truecolor-or-graphic-p) "#88C0D0" "brightcyan"))
      (nordic-night-lapis9 (if (nordic-night-display-truecolor-or-graphic-p) "#81A1C1" "blue"))
      (nordic-night-blue10 (if (nordic-night-display-truecolor-or-graphic-p) "#5E81AC" "brightblue"))
      (nordic-night-red11 (if (nordic-night-display-truecolor-or-graphic-p) "#BF616A" "red"))
      (nordic-night-orange12 (if (nordic-night-display-truecolor-or-graphic-p) "#D08770" "brightyellow"))
      (nordic-night-yellow13 (if (nordic-night-display-truecolor-or-graphic-p) "#EBCB8B" "yellow"))
      (nordic-night-green14 (if (nordic-night-display-truecolor-or-graphic-p) "#A3BE8C" "green"))
      (nordic-night-purple15 (if (nordic-night-display-truecolor-or-graphic-p) "#B48EAD" "magenta"))
...
;;;; +------------+
  (custom-theme-set-faces
    ...
    `(hl-line ((,class (:background ,nordic-night-dark1))))
    ...
    `(markdown-header-face-1 ((,class (:foreground ,nordic-night-brightblue8))))
    `(markdown-header-face-2 ((,class (:foreground ,nordic-night-brightblue8))))
    `(markdown-header-face-3 ((,class (:foreground ,nordic-night-brightblue8))))
    `(markdown-header-face-4 ((,class (:foreground ,nordic-night-brightblue8))))
    `(markdown-header-face-5 ((,class (:foreground ,nordic-night-brightblue8))))
    `(markdown-header-face-6 ((,class (:foreground ,nordic-night-brightblue8))))
   ...
   `(diff-hl-delete ((,class (:background ,nordic-night-red11))))
    ...
    ;; > Org
    `(org-level-1 ((,class (:foreground ,nordic-night-bluegreen7 :weight extra-bold))))
    `(org-level-2 ((,class (:foreground ,nordic-night-brightblue8 :weight bold))))
    `(org-level-3 ((,class (:foreground ,nordic-night-lapis9 :weight semi-bold))))
    `(org-level-4 ((,class (:foreground ,nordic-night-blue10 :weight normal))))
    ...
    `(org-agenda-date ((,class (:foreground ,nordic-night-brightblue8 :underline nil))))
    `(org-agenda-done ((,class (:foreground ,nordic-night-green14))))
    ...
    `(org-code ((,class (:foreground ,nordic-night-bluegreen7))))
    ...
    `(org-scheduled-previously ((,class (:foreground ,nordic-night-yellow13))))
    `(org-scheduled-today ((,class (:foreground ,nordic-night-brightblue8))))
    `(org-special-keyword ((,class (:foreground ,nordic-night-lapis9))))
    `(org-table ((,class (:foreground ,nordic-night-lapis9))))
    `(org-todo ((,class (:foreground ,nordic-night-yellow13 :weight bold))))
    `(org-upcoming-deadline ((,class (:foreground ,nordic-night-orange12))))
    `(org-warning ((,class (:foreground ,nordic-night-yellow13 :weight bold))))
    `(font-latex-bold-face ((,class (:inherit bold))))
    ...
    `(org-agenda-date-today ((,class (:foreground ,nordic-night-brightblue8 :weight bold))))
    `(org-agenda-done ((,class (:foreground ,nordic-night-green14))))
