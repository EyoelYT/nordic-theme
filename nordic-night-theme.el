...
;;; -- Base
     ...
     `(error ((,class (:foreground ,nn-red11 :inherit bold))))
     `(escape-glyph ((,class (:foreground ,nn-orange12))))
     `(font-lock-builtin-face ((,class (:foreground ,nn-lapis9))))
     `(font-lock-comment-face ((,class (:foreground ,nn-comment :inherit light))))
     ...
     `(font-lock-preprocessor-face ((,class (:foreground ,nn-blue10 :inherit bold))))
...
;;; --- CPerl
     `(cperl-hash-face ((,class (:foreground ,nn-bluegreen7 :background nil :inherit bold))))
     `(cperl-array-face ((,class (:foreground ,nn-bluegreen7 :background nil :inherit bold))))
...
;;; --- diff
     ...
     `(diff-header ((,class (:foreground ,nn-lapis9 :inherit bold))))
...
;;; -- UI
     ...
     `(buffer-menu-buffer ((,class (:foreground ,nn-snowy4 :inherit bold))))
     ...
     `(completions-common-part ((,class (:foreground ,nn-brightblue8 :inherit bold))))
     ...
     `(custom-group-tag ((,class (:foreground ,nn-brightblue8 :inherit bold))))
     `(custom-group-tag-1 ((,class (:foreground ,nn-brightblue8 :inherit bold))))
     ...
     `(minibuffer-prompt ((,class (:foreground ,nn-brightblue8 :inherit bold))))
     ...
     `(outline-1 ((,class (:foreground ,nn-brightblue8 :inherit bold))))
     ...
     `(package-help-section-name ((,class (:foreground ,nn-brightblue8 :inherit bold))))
     `(package-name ((,class (:foreground ,nn-brightblue8))))
     `(package-status-available ((,class (:foreground ,nn-bluegreen7))))
     `(package-status-avail-obso ((,class (:foreground ,nn-bluegreen7 :inherit italic))))
     `(package-status-built-in ((,class (:foreground ,nn-lapis9))))
     `(package-status-dependency ((,class (:foreground ,nn-brightblue8 :inherit italic))))
     `(package-status-disabled ((,class (:foreground ,nn-dark3))))
     `(package-status-external ((,class (:foreground ,nn-orange12 :inherit italic))))
     `(package-status-held ((,class (:foreground ,nn-snowy4 :inherit bold))))
     `(package-status-new ((,class (:foreground ,nn-green14))))
     `(package-status-incompat ((,class (:foreground ,nn-red11))))
     `(package-status-installed ((,class (:foreground ,nn-bluegreen7 :inherit bold))))
     ...
     `(whitespace-empty ((,class (:foreground ,nn-dark3 :background ,nn-nearblack))))
     `(whitespace-hspace ((,class (:foreground ,nn-dark3 :background ,nn-nearblack))))
     `(whitespace-indentation ((,class (:foreground ,nn-dark3 :background ,nn-nearblack))))
     `(whitespace-line ((,class (:background ,nn-nearblack))))
     `(whitespace-newline ((,class (:foreground ,nn-dark3 :background ,nn-nearblack))))
     `(whitespace-space ((,class (:foreground ,nn-dark3 :background ,nn-nearblack))))
     `(whitespace-space-after-tab ((,class (:foreground ,nn-dark3 :background ,nn-nearblack))))
     `(whitespace-space-before-tab ((,class (:foreground ,nn-dark3 :background ,nn-nearblack))))
     `(whitespace-tab ((,class (:foreground ,nn-dark3 :background ,nn-nearblack))))
...
;;; --- Auctex
     ...
     `(font-latex-sectioning-0-face ((,class (:foreground ,nn-brightblue8 :inherit bold))))
...
;;; --- Java Development Environment for Emacs
     `(jdee-db-active-breakpoint-face ((,class (:background ,nn-dark2 :inherit bold))))
     `(jdee-bug-breakpoint-cursor ((,class (:background ,nn-dark2))))
     `(jdee-db-requested-breakpoint-face ((,class (:foreground ,nn-yellow13 :background ,nn-dark2 :inherit bold))))
     `(jdee-db-spec-breakpoint-face ((,class (:foreground ,nn-green14 :background ,nn-dark2 :inherit bold))))
     `(jdee-font-lock-api-face ((,class (:foreground ,nn-snowy4))))
     `(jdee-font-lock-code-face ((,class (:inherit italic))))
     ...
     `(jdee-font-lock-pre-face ((,class (:foreground ,nn-comment :inherit italic))))
...
;;; --- Company
     ...
     `(company-tooltip-annotation-selection ((,class (:foreground ,nn-orange12 :inherit bold))))
     ...
     `(company-tooltip-selection ((,class (:background ,nn-dark3 :inherit bold))))
...
;;; --- Flycheck
     ...
     `(flycheck-fringe-error ((,class (:foreground ,nn-red11 :inherit bold))))
     `(flycheck-fringe-info ((,class (:foreground ,nn-brightblue8 :inherit bold))))
     `(flycheck-fringe-warning ((,class (:foreground ,nn-yellow13 :inherit bold))))
...
;;; --- Helm
     ...
     `(helm-candidate-number ((,class (:foreground ,nn-snowy4 :inherit bold))))
     `(helm-candidate-number-suspended ((,class (:foreground ,nn-snowy4))))
     `(helm-ff-directory ((,class (:foreground ,nn-lapis9 :inherit bold))))
     `(helm-ff-dirs ((,class (:foreground ,nn-lapis9))))
     `(helm-ff-dotted-director ((,class (:foreground ,nn-lapis9 :underline t))))
     `(helm-ff-dotted-symlink-director ((,class (:foreground ,nn-bluegreen7 :inherit bold))))
     `(helm-ff-executable ((,class (:foreground ,nn-brightblue8))))
     `(helm-ff-file ((,class (:foreground ,nn-snowy4))))
     `(helm-ff-invalid-symlink ((,class (:foreground ,nn-red11 :inherit bold))))
     ...
     `(helm-lisp-completion-info ((,class (:foreground ,nn-snowy4 :inherit bold))))
...
;;; --- Magit
     `(magit-branch ((,class (:foreground ,nn-bluegreen7 :inherit bold))))
     ...
     `(magit-process-ng ((,class (:foreground ,nn-yellow13 :inherit bold))))
     `(magit-process-ok ((,class (:foreground ,nn-green14 :inherit bold))))
     `(magit-section-heading ((,class (:foreground ,nn-bluegreen7 :inherit bold))))
...
;;; --- MU4E
     ...
     `(mu4e-related-face ((,class (:foreground ,nn-lessdark3-1 :inherit italic))))
     `(mu4e-highlight-face ((,class (:highlight))))
     `(mu4e-flagged-face ((,class (:foreground ,nn-yellow13))))
     `(mu4e-unread-face ((,class (:foreground ,nn-green14 :inherit bold))))
...
;;; --- NeoTree
     ...
     `(neo-root-dir-face ((,class (:foreground ,nn-bluegreen7 :inherit bold))))
...
;;; --- Org
     `(org-level-1 ((,class (:foreground ,nn-brightblue8 :inherit extra-bold))))
     `(org-level-2 ((,class (:foreground ,nn-lapis9 :inherit bold))))
     `(org-level-3 ((,class (:foreground ,nn-blue10 :inherit semi-bold))))
     ...
     `(org-agenda-date-today ((,class (:foreground ,nn-blue10 :inherit bold :inverse-video t :underline nil :extend t))))
     `(org-agenda-date-weekend ((,class (:foreground ,nn-lapis9))))
     `(org-agenda-dimmed-todo-face ((,class (:background ,nn-yellow13))))
     `(org-agenda-done ((,class (:foreground ,nn-lessdark3-2 :inherit (light italic)))))
     ...
     `(org-column-title ((,class (:inherit (org-column bold) :underline t))))
     `(org-date ((,class (:foreground ,nn-brightblue8))))
     `(org-document-info ((,class (:foreground ,nn-snowy4))))
     `(org-document-info-keyword ((,class (:foreground ,nn-lessdark3-1 :inherit bold))))
     `(org-document-title ((,class (:foreground ,nn-brightblue8 :inherit bold))))
     `(org-done ((,class (:foreground ,nn-green14 :inherit bold))))
     ...
     `(org-quote ((,class (:inherit (org-block italic) :foreground ,nn-green14))))
     ...
     `(org-todo ((,class (:foreground ,nn-orange12 :inherit bold))))
     ...
     `(org-verse ((,class (:inherit (org-block italic)))))
     `(org-warning ((,class (:foreground ,nn-red11 :inherit bold))))
     ...
     `(ido-first-match ((,class (:foreground ,nn-brightblue8 :inherit bold))))
...
;;; --- perspective
     `(persp-selected-face ((,class (:foreground ,nn-brightblue8 :inherit bold))))
